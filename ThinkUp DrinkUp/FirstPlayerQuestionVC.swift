...
class FirstPlayerQuestionVC: UIViewController, UITextViewDelegate {
     ...
     @IBAction func CommitAnswer1AndContinue(_ sender: AnyObject) {
    ...
    override func viewDidLoad() {
     ...
     func textView(_ AnswerBox1: UITextView, shouldChangeTextIn range: NSRange, replacementText text: String) -> Bool {
          if (text == "\n") {

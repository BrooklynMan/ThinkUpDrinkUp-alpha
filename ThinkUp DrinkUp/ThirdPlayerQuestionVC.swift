...
class ThirdPlayerQuestionVC: UIViewController, UITextViewDelegate {
     ...
     @IBAction func CommitAnswer3AndContinue(_ sender: AnyObject) {
    ...
    override func viewDidLoad() {
     ...
     func textView(_ AnswerBox3: UITextView, shouldChangeTextIn range: NSRange, replacementText text: String) -> Bool {
          if (text == "\n") {
